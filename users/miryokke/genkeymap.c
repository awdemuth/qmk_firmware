...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [QWERTY] = LAYOUT_miryokke(
        ...
        LCTL_T(KC_ESC),    LCTL_T(KC_A),      LGUI_T(KC_S),      LALT_T(KC_D),      LSFT_T(KC_F),      KC_G,              KC_H,              LSFT_T(KC_J),      LALT_T(KC_K),      LGUI_T(KC_L),      LCTL_T(KC_QUOT),   KC_SCLN,
    ...
    [COLEMAK] = LAYOUT_miryokke(
        ...
        LCTL_T(KC_ESC),    LCTL_T(KC_A),      LGUI_T(KC_R),      LALT_T(KC_S),      LSFT_T(KC_T),      KC_G,              KC_M,              LSFT_T(KC_N),      LALT_T(KC_E),      LGUI_T(KC_I),      LCTL_T(KC_O),      KC_SCLN,
    ...
    [NAV] = LAYOUT_miryokke(
        ...
        KC_LCTL  , KC_LCTL  , KC_LGUI  , KC_LALT  , KC_LSFT  , KC_NA    , KC_CAPS  , KC_LEFT  , KC_DOWN  , KC_UP    , KC_RGHT  , KC_NU    ,
    ...
    [MOUSE] = LAYOUT_miryokke(
        ...
        KC_LCTL  , KC_LCTL  , KC_LGUI  , KC_LALT  , KC_LSFT  , KC_NA    , KC_NU    , KC_MS_L  , KC_MS_D  , KC_MS_U  , KC_MS_R  , KC_NU    ,
    ...
    [MEDIA] = LAYOUT_miryokke(
        ...
        KC_LCTL  , KC_LCTL  , KC_LGUI  , KC_LALT  , KC_LSFT  , KC_NA    , KC_NU    , KC_MPRV  , KC_VOLD  , KC_VOLU  , KC_MNXT  , KC_NU    ,
